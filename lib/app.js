...
function createApp ({
  ...
  app.get('/data/website.json', (req, res, next) => {
    databaseDriver.getWebsite().then(o => res.send(o), next)
  })
  app.get('/data/pages/:name.json', (req, res, next) => {
    databaseDriver.getPage(req.params.name).then(o => res.send(o), next)
  })
  app.get('/data/objects/:id.json', (req, res, next) => {
    databaseDriver.getObject(req.params.id).then(o => res.send(o), next)
  })
